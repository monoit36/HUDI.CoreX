...
export class RoleServiceProxy {
     ...
     * @return OK
     */
    getPermissionTree(): Observable<PermissionTreeDtoTreeResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Role/GetPermissionTree";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetPermissionTree(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetPermissionTree(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<PermissionTreeDtoTreeResultDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<PermissionTreeDtoTreeResultDto>;
        }));
    }

    protected processGetPermissionTree(response: HttpResponseBase): Observable<PermissionTreeDtoTreeResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = PermissionTreeDtoTreeResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
...
export class SiteServiceProxy {
     ...
     * @return OK
     */
    getAll(keyword: string | undefined, isActive: boolean | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<SiteDtoPagedResultDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<SiteDtoPagedResultDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<SiteDtoPagedResultDto>;
        }));
    }
     ...
     * @return OK
     */
    update(body: UpdateSiteDto | undefined): Observable<SiteDto> {
...
export class PermissionTreeDtoTreeResultDto implements IPermissionTreeDtoTreeResultDto {
    items: PermissionTreeDto[] | undefined;

    constructor(data?: IPermissionTreeDtoTreeResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): PermissionTreeDtoTreeResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new PermissionTreeDtoTreeResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): PermissionTreeDtoTreeResultDto {
        const json = this.toJSON();
        let result = new PermissionTreeDtoTreeResultDto();
        result.init(json);
        return result;
...
export interface IPermissionTreeDtoTreeResultDto {
    items: PermissionTreeDto[] | undefined;
}
...
export class UpdateSiteDto implements IUpdateSiteDto {
    id: number;
    code: string;
    name: string;
    status: string | undefined;
    ...
    constructor(data?: IUpdateSiteDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): UpdateSiteDto {
        data = typeof data === 'object' ? data : {};
        let result = new UpdateSiteDto();
        result.init(data);
        return result;
    }
