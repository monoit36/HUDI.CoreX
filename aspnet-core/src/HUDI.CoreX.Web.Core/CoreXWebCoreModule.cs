...
using HUDI.CoreX.Authentication.JwtBearer;
...
namespace HUDI.CoreX
{
    ...
    public class CoreXWebCoreModule : AbpModule
    {
        ...
        public CoreXWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(CoreXWebCoreModule).GetAssembly());
        }

        public override void PostInitialize()
        {
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(CoreXWebCoreModule).Assembly);
        }
    }
}
