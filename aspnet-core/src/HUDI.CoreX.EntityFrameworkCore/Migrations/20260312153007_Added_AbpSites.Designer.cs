...
namespace HUDI.CoreX.Migrations
{
    ...
    [Migration("20260312153007_Added_AbpSites")]
    partial class Added_AbpSites
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HUDI.CoreX.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HUDI.CoreX.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("HUDI.CoreX.DemoProducts.DemoProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("AppDemoProducts");
                });

            modelBuilder.Entity("HUDI.CoreX.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HUDI.CoreX.Sites.Site", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("HUDI.CoreX.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("HUDI.CoreX.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("HUDI.CoreX.Authorization.Roles.Role", b =>
                {
                    b.HasOne("HUDI.CoreX.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("HUDI.CoreX.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("HUDI.CoreX.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
