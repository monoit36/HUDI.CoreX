...
using HUDI.CoreX.Localization.Extensions;
...
namespace HUDI.CoreX.Roles
{
    ...
    public class RoleAppService : AsyncCrudAppService<Role, RoleDto, int, PagedRoleResultRequestDto, CreateRoleDto, RoleDto>, IRoleAppService
    {
        ...
        public Task<TreeResultDto<PermissionTreeDto>> GetPermissionTreeAsync()
        {
            var permissions = PermissionManager.GetAllPermissions();
            ...
            return Task.FromResult(new TreeResultDto<PermissionTreeDto>(rootPermissions));
        }

        private List<PermissionTreeDto> GetChildPermissions(string parentName, IEnumerable<Permission> allPermissions)
        {
            return allPermissions
                .Where(p => p.Parent.Name == parentName)
                .Select(p => new PermissionTreeDto
                {
                    Name = p.Name,
                    DisplayName = p.DisplayName.GetRawString(),
