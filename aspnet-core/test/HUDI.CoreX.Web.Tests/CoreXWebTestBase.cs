...
{
    public abstract class CoreXWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static CoreXWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(CoreXWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<CoreXDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<CoreXDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<CoreXDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<CoreXDbContext, Task<T>> func)
        {
            T result;
